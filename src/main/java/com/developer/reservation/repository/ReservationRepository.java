...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
	//[SR] 스터디카페 예약내역 목록 출력
	@Query(value="SELECT r.res_seq, ri.roomName as riName, r.user_id, u.name As uName, r.host_id,"
			...
			+ "JOIN studycafe sr ON   sr.cafe_seq = ri.cafe_seq "
	...
	public List<Object[]> selectAllReservation(@Param("hostId")String hostId);
		...
		//[SR] 스터디카페 예약상세내역
		@Query(value="SELECT r.res_seq, r.user_id, u.name As uname, u.tel, rif.room_name, r.using_date, r.start_time, r.end_time, r.host_id "
				+ "FROM room_info rif "
		...
		@Query(value = "select r.room_seq, r.start_time, r.end_time, r.using_date, ro.price, sr.open_time,sr.end_time AS srEndTime, r.user_id\r\n"
				+ "from reservation r, room_info ro, studycafe sr\r\n"
				...
				+ "AND sr.cafe_seq = ro.cafe_seq ", nativeQuery = true)
		public List<Object[]> findAllByUsingDate(@Param("roomSeq") Long roomSeq, @Param("usingDate") String usingDate);
		
		//[DS]유저 아이디로 예약내역 찾기O
		@Query(value="SELECT r. res_seq, s.cafe_name AS sName, rif.room_name AS rifName, r.using_date, r.start_time, r.end_time\r\n"
				+ "FROM studycafe s, room_info rif, reservation r\r\n"
		...
		@Query(value= "SELECT r.res_seq , s.cafe_name AS sName, rif.room_name AS rifName, r.using_date, r.start_time, r.end_time\r\n"
				...
				+ "MINUS\r\n"
				+ "SELECT r.res_seq, s.cafe_name AS sName, rif.room_name AS rifName, r.using_date, r.start_time, r.end_time\r\n"
